...
![صورة من نظام (DORIS) الإلكتروني ](img/DORISwebjune252.png){: style="width:40%"}
...
![صورة من قسم البيانات الإدارية ](img/administrativedatascreenshotupdated2.png){: style="width:40%"}
...
![الإطار أ: لقطة شاشة للبيانات الطبية ](img/FrameAmedicaldatascreenshotupdated2.png){: style="width:40%"}
...
![الجراحة: لقطة شاشة ](img/surgeryandautopsyscreenshot2.png){: style="width:40%"}

**طريقة الوفاة**: حدد طريقة حدوث الوفاة (مثل: طبيعية، حادث، انتحار، قتل).

![طريقة الوفاة: لقطة شاشة ](img/manneofdeathscreenshotupdated2.png){: style="width:40%"}
...
![صورة لوفاة الجنين أو الرضيع ](img/fetalinfantdeathscreenshotupdated2.png){: style="width:40%"}
...
![صورة للحمل ](img/pregnancyscreenshotupdated2.png){: style="width:40%"}
...
![استعراض شهادات الوفاة](img/browsemccds2.png){: style="width:30%"}
...
![شرح تفصيلي للمخرجات](img/outputdetailedexplanationscreenshot2.png){: style="width:40%"}
...
![صورة 10 ](img/textualreport2.png){: style="width:40%"}
...
![صورة 11 ](img/Tabularreport2.png){: style="width:40%"}
...
![صورة 13 ](img/Rulesequencereport2.png){: style="width:40%"}
